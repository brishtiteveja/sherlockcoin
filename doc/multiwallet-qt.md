...
In order to support loading of multiple wallets in sherlockcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to sherlockcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into sherlockcoin-qt, and as such, will require some minor modifications to provide hooks for
