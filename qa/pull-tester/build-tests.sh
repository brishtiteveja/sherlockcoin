...
DISTDIR=sherlockcoin-1.8.2

# Cross-compile for windows first (breaking the mingw/windows build is most common)
cd /Users/ananda/Documents/Workspace/my_github/sherlockcoin
make distdir
mkdir -p win32-build
...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build
make check

# Run RPC integration test on Linux:
/Users/ananda/Documents/Workspace/my_github/sherlockcoin/qa/rpc-tests/wallet.sh /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build/src
/Users/ananda/Documents/Workspace/my_github/sherlockcoin/qa/rpc-tests/listtransactions.py --srcdir /Users/ananda/Documents/Workspace/my_github/sherlockcoin/linux-build/src
# Clean up cache/ directory that the python regression tests create
rm -rf cache

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /Users/ananda/Documents/Workspace/my_github/sherlockcoin/win32-build
  make check
fi
