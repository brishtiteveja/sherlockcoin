...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("1"));
        ...
        copyrightLabel->setText(QStringLiteral(""));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About sherlockcoin Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p>Sherlock Holmes Coin Core Version</p></body></html>", 0));
        label_2->setText(QApplication::translate("AboutDialog", "Experiment for Crypto Project", 0));
    } // retranslateUi
