...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        OverviewPage->resize(591, 525);
        OverviewPage->setStyleSheet(QStringLiteral("background-color:rgb(255, 203, 215)"));
        ...
        label_wallet_bgcoin->setPixmap(QPixmap(QString::fromUtf8(":/images/about")));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the sherlockcoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the sherlockcoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
