...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to SherlockHolmesCoin.", 0));
        label_4->setText(QString());
        sizeWarningLabel->setText(QApplication::translate("Intro", "Choose for data directory.", 0));
