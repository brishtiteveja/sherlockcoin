    ...
    ui(new Ui::AboutDialog)
{
    ...
    ui->copyrightLabel->setText(tr("Copyright") + QString(" &copy; 2009-%1 ").arg(COPYRIGHT_YEAR) + tr("The Bitcoin Core developers") + QString("<br>") + tr("Copyright") + QString(" &copy; 2013-%1 ").arg(COPYRIGHT_YEAR) + tr("The sherlockcoin developers"));
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("sherlockcoin Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  sherlockcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("sherlockcoin Core is shutting down...") + "<br /><br />" +
