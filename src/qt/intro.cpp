...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("sherlockcoin"),
     ...
     * override -datadir in the sherlockcoin.conf file in the default data directory
     * (to be consistent with sherlockcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
