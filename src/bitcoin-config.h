...
#define PACKAGE_BUGREPORT "info@sherlockcoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sherlockcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sherlockcoin Core 1.8.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sherlockcoin"
